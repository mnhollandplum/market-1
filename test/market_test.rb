...
class MarketTest < Minitest::Test
  ...
  def test_can_create_a_sorted_item_list
  ...
  def test_market_can_get_total_inventory_per_item
    market = Market.new("South Pearl Street Farmers Market")
  ...
  def test_get_inventory_helper_method
    market = Market.new("South Pearl Street Farmers Market")
    ...
    assert_equal [{"Peaches"=>35, "Tomatoes"=>7}, {"Banana Nice Cream"=>50, "Peach-Raspberry Nice Cream"=>25}, {"Peaches"=>65}], market.get_inventory
  end
end
